...
[![Tests](https://github.com/teksyn-25/guardbox-tek/actions/workflows/test.yml/badge.svg)](https://github.com/teksyn-25/guardbox-tek/actions/workflows/test.yml)
...
- A Linux machine (Fedora 39+, Ubuntu 22.04+, or Debian 12+) to stay on and reachable from your phone whenever you want to share a file from the GuardBox client installed on your mobile.
